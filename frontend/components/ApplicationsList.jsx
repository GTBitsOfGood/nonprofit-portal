              ...
              <CSSTransition timeout={500} classNames="fade">
                <ListGroupItem>
                  <div style={{ display: 'flex', margin: '30px 0' }}>
                    ...
                    <ButtonGroup>
                      <Button color="primary" onClick={this.changeAppState(0)}>1</Button>
                      <Button color="primary" onClick={this.changeAppState(1)}>2</Button>
                      <Button color="primary" onClick={this.changeAppState(2)}>3</Button>
                      <Button color="primary" onClick={this.changeAppState(3)}>4</Button>
                    </ButtonGroup>
                  </div>
